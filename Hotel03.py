...
class Hotel03Spider(scrapy.Spider):
   ...
   #allowed_domains = ['tripadvisor.com']
    ...
    def start_requests(self):
        ...
        driver.get('https://www.tripadvisor.com/Hotels-g293926-Hue_Thua_Thien_Hue_Province-Hotels.html/')
    ...
    def parse(self, response):
        ...
        #<div class="gqDVW w h f e u j _P c C4 cxnyp"><div class="fgdlj"><span class="ui_icon hotels KnOKA cAPAi _Q"></span></div>Room &amp; Suite<span class="cXdRV"> (193) </span></div>
        traveler_pic = response.xpath('//span[@class="cXdRV"]/text()').get()
        ...
        price =  response.xpath('//div[@class="cJdpk Ci"]/text()')[0:3].getall()
